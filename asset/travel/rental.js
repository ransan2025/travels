...
async function loadSetupData() {
    try {
        ...
        const res = await fetch(
            "https://script.google.com/macros/s/AKfycbxzjG7PzGYXumIEVVEDkM3WRqeH6dZjUsY7uQdk0n9z0nygYDgcPfyopGlx6o2PZKTo/exec?action=getSetup"
        );
...
async function rsSubmitBooking() {
    ...
    try {
        ...
        const isPerKm =
            window.rsPriceType === "km";

        const isPerDay =
            window.rsPriceType === "day";
...
• Final confirmation via WhatsApp/Call
...
🚀 Immediate Follow-up Recommended`;
        ...
        await fetch(
            ...
            "https://script.google.com/macros/s/AKfycbxzjG7PzGYXumIEVVEDkM3WRqeH6dZjUsY7uQdk0n9z0nygYDgcPfyopGlx6o2PZKTo/exec",
...
🚀 Immediate follow-up recommended`;
        ...
        const response =
            await fetch(
                ...
                "https://script.google.com/macros/s/AKfycbxsCC-AZ1ruDqfNjESBdtDUvDB6CHmP04d6CmApAayBGPraF2cdHpdq6f8RibMMjZWi/exec",
