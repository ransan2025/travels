...
async function rsLoadRentals() {
    ...
    try {
        ...
        const response = await fetch(
            "https://script.google.com/macros/s/AKfycbycM5nozCj6zdkcihc645kSo8UehaR1R0Yh2TCMVdYCrQT_1M1yPS4-hXwAQVmMTE1-/exec?action=getCarRentals"
        );
...
async function loadSetupData() {
    try {
        ...
        const res = await fetch(
            "https://script.google.com/macros/s/AKfycbycM5nozCj6zdkcihc645kSo8UehaR1R0Yh2TCMVdYCrQT_1M1yPS4-hXwAQVmMTE1-/exec?action=getSetup"
        );
...
<div class="rs-floating-action-bar">
    ...
    <button
        ...
        onclick='rsOpenLeadPopup(${JSON.stringify(car)})'
    >
...
🚀 Immediate Follow-up Recommended`;
        ...
        await fetch(
            ...
            "https://script.google.com/macros/s/AKfycbycM5nozCj6zdkcihc645kSo8UehaR1R0Yh2TCMVdYCrQT_1M1yPS4-hXwAQVmMTE1-/exec",
