...
async function rsLoadPackages() {
    ...
    try {
        ...
        const response =
            await apiFetch("getTourPackages");
...
async function rsSubmitLead() {
    ...
    const payload = {
        ...
        data: {
            ...
            "Customer Name": document.getElementById("rsLeadName").value.trim(),

            "Phone": document.getElementById("rsLeadPhone").value.trim(),

            "Package": document.getElementById("rsLeadPackage").value.trim(),

            "Travel Month": document.getElementById("rsLeadMonth").value,

            "Adults": document.getElementById("rsLeadAdults").value,

            "Child": document.getElementById("rsLeadChild").value,

            "Infant": document.getElementById("rsLeadInfant").value,

            "Budget": document.getElementById("rsLeadBudget").value,
    ...
    if (!payload.data["Customer Name"]) {
        ...
        rsShowToast("Please enter your name", "error");
        return;
    ...
    if (!payload.data["Phone"]) {
        ...
        rsShowToast("Please enter mobile number", "error");
        return;
    ...
    if (!payload.data["Package"]) {
        ...
        rsShowToast("Package not selected", "error");
        return;
...
async function submitPremiumQuote() {
    ...
    const txt = document.getElementById("premiumBtnText");
    const loader = document.getElementById("premiumLoader");

    btn.disabled = true;
    txt.innerHTML = "Submitting...";
    ...
    const payload = {
        ...
        data: {
            ...
            "Customer Name": document.getElementById("pqName").value.trim(),

            "Phone": document.getElementById("pqPhone").value.trim(),

            "Service": document.getElementById("pqService").value,

            "Travel Month": document.getElementById("pqMonth").value,

            "Travellers": document.getElementById("pqTravellers").value,

            "Message": document.getElementById("pqMessage").value,
    ...
    if (!payload.data["Customer Name"]) {
        ...
        txt.innerHTML = "Get My Custom Quote";
