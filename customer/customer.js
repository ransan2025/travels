...
function renderBookingDetails(booking) {
    ...
    /* =========================================
   LOAD CUSTOMER BOOKING DOCUMENTS
   ========================================= */
...
function renderDocumentsSection(
    ...
    return `
        ...
        >
            ...
            <div class="portalDocumentsHeaderV1">
                ...
                <div>
                    ...
                    <small>
                        Secure travel documents for this booking
                    </small>
                ...
                <button
                    type="button"
                    class="portalDocumentsRefreshV1"
                    onclick="
                        window.RanSanCustomerDocuments
                            ?.load('${safeBooking}')
                    "
            ...
            <div
                id="portalDocumentsList_${bookingDomId}"
                class="portalDocumentsListV1"
            >
...
<div class="customerDocumentSubmitArea">

    <div class="customerDocumentSubmitHeader">
        ...
        <div>
            ...
            <small>
                Aadhaar, PAN, Passport, Visa or other requested travel documents
            </small>
        ...
        <button
            type="button"
            class="customerDocumentSubmitOpen"
            onclick="
                window.RanSanCustomerDocuments
                    ?.openUpload('${safeBooking}')
            "
        >
            ↑ Upload Document
        </button>
    ...
    <div
        id="customerDocumentUpload_${bookingDomId}"
        class="customerDocumentUploadPanel"
        hidden
    >

        <div class="customerDocumentUploadNotice">
            ...
            <div>
                ...
                <small>
                    Your document is sent directly to RanSan's private document storage and is not made public.
                </small>
        ...
        <label class="customerDocumentUploadField">
            ...
            <select
                id="customerDocumentType_${bookingDomId}"
            >
                ...
                <option value="Other Customer Document">
                    Other Document
                </option>
        ...
        <label class="customerDocumentUploadField">
            ...
            <input
                id="customerDocumentFile_${bookingDomId}"
                type="file"
        ...
        <label class="customerDocumentConsent">

            <input
                id="customerDocumentConsent_${bookingDomId}"
                type="checkbox"
            >

            <span>
                I confirm that I am authorized to submit this document to RanSan Travels for processing my booking/travel service.
            </span>
        ...
        <div
            id="customerDocumentUploadStatus_${bookingDomId}"
            class="customerDocumentUploadStatus"
        ></div>


        <div class="customerDocumentUploadActions">

            <button
                type="button"
                class="customerDocumentUploadCancel"
                onclick="
                    window.RanSanCustomerDocuments
                        ?.closeUpload('${safeBooking}')
                "
            >
                Cancel
            </button>
            ...
            <button
                type="button"
                id="customerDocumentUploadBtn_${bookingDomId}"
                class="customerDocumentUploadConfirm"
                onclick="
                    window.RanSanCustomerDocuments
                        ?.upload('${safeBooking}')
                "
