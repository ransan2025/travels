...
<button
    ...
    onclick="window.RanSanInvoice?.open(currentCustomerV2.raw)"
...
<button
    ...
    class="
        crmGlassV2ActionBtn
        crmGlassV2DocumentsBtn
    "
    onclick="
        window.RanSanDocuments
            ?.open(currentCustomerV2.raw)
    "
    title="Manage Booking Documents"
>
...
<button
    ...
    class="
        crmGlassV2ActionBtn
        crmGlassV2CostProfitBtn
    "
    onclick="
        window.RanSanBookingCost
            ?.open(
                currentCustomerV2.raw
            )
    "
    title="Booking Cost & Actual Profit"
>
...
<button
    type="button"
    id="crmPaymentReminderBtn"
    class="
        crmGlassV2ActionBtn
        crmGlassV2PaymentReminderBtn
    "
    onclick="
        window.RanSanPaymentReminder
            ?.open(currentCustomerV2.raw)
    "
    title="Send Outstanding Payment Reminder">
...
<button
    type="button"
    id="crmRefundHistoryBtn"
    class="
        crmGlassV2ActionBtn
        crmGlassV2RefundHistoryBtn
    "
    onclick="
