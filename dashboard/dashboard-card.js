...
function renderTab(service, pendingOnly = false) {
    ...
    switch (service) {
        ...
        case "Flight":
            arr = dashboardData.air || [];
            break;

        case "Train":
            arr = dashboardData.train || [];
            break;

        case "Bus":
            arr = dashboardData.bus || [];
            break;

        case "Car":
            arr = dashboardData.cars || [];
            break;

        case "Package":
            arr = dashboardData.packages || [];
            break;

        case "Quote":
            arr = dashboardData.quotes || [];
            break;
    ...
    console.log("Loaded Records =", arr.length);
...
function applyCRMFilters() {
    ...
    if (keyword) {
        ...
        rows = rows.filter(r => {
            ...
            return (
                ...
                getCustomerName(r).toLowerCase().includes(keyword)

                ||

                getCustomerPhone(r).toLowerCase().includes(keyword)

                ||

                getCustomerRoute(r).toLowerCase().includes(keyword)
    ...
    if (filter !== "All") {
        ...
        rows = rows.filter(r => {
            ...
            return getCustomerStatus(r) === filter;
    ...
    switch (sort) {
        ...
        case "name":
            ...
            rows.sort((a, b) =>
                ...
                getCustomerName(a).localeCompare(
        ...
        case "date":
            ...
            rows.sort((a, b) =>
                ...
                new Date(getCustomerDate(a))

                -

                new Date(getCustomerDate(b))
        ...
        case "status":
            ...
            rows.sort((a, b) =>
                ...
                (statusOrder[getCustomerStatus(a)] || 99)

                -

                (statusOrder[getCustomerStatus(b)] || 99)
        ...
        case "priority":
            ...
            rows.sort((a, b) =>
                ...
                (priorityOrder[getCustomerStatus(a)] || 99)

                -

                (priorityOrder[getCustomerStatus(b)] || 99)
    ...
    console.log(
        document.getElementById("tabContent").innerHTML.length
    );
...
function groupByStatus(arr) {
    ...
    arr.forEach(function (x) {
        ...
        if (status == "new") {
            ...
            groups.Pending.push(x);

        }

        else if (status == "processing") {

            groups.Processing.push(x);

        }

        else if (status == "follow up") {

            groups.FollowUp.push(x);

        }

        else {

            groups.Completed.push(x);
...
function updateTabCounters() {
    ...
    document.getElementById("countFlight").innerHTML =
        dashboardData.air.length;

    document.getElementById("countTrain").innerHTML =
        dashboardData.train.length;

    document.getElementById("countBus").innerHTML =
        dashboardData.bus.length;

    document.getElementById("countCar").innerHTML =
        dashboardData.cars.length;

    document.getElementById("countPackage").innerHTML =
