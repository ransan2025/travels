...
async function loadModificationRequests() {
    ...
    try {
        ...
        /* =====================================================
           SHARE WITH NOTIFICATION CENTER
        ===================================================== */

        /*
         * Make the same request array available globally.
         */
        ...
        /*
         * Push the latest data into the notification module.
         */

        if (
            window.DashNotification &&
            typeof window.DashNotification.setModificationRequests ===
            "function"
        ) {
        ...
        console.log(
            "[MODIFICATION] Shared with Notification Center:",
    ...
    return `
        ...
        >
            ...
            <div class="modificationRequestTop">
                ...
                <div class="modificationBookingInfo">

                    <div class="modificationBookingId">
                        Booking:
                        ${escapeModificationHtml(bookingId)}
                    </div>

                    <div class="modificationCustomer">
                        ${escapeModificationHtml(customer)}
                        ·
                        ${escapeModificationHtml(phone)}
                    </div>
        ...
        statusClass
            ...
            <div class="modificationMeta">
                ...
                >
                    ...
                    <span class="modificationTagIcon">
                        🧳
                    </span>

                    <span class="modificationTagLabel">
                        SERVICE
                    </span>
        ...
        getModificationRequestTypeLabel(requestType)
                ...
                >
                    ...
                    <span class="modificationTagValue">
                        ${escapeModificationHtml(requestedDate)}
                    </span>
